...
Xtrain_path = "hf://datasets/aravindshaz3/travel-package-sales/Xtrain.csv"
Xtest_path = "hf://datasets/aravindshaz3/travel-package-sales/Xtest.csv"
ytrain_path = "hf://datasets/aravindshaz3/travel-package-sales/ytrain.csv"
ytest_path = "hf://datasets/aravindshaz3/travel-package-sales/ytest.csv"
...
#target = 'ProdTaken'       # Customer's credit score
...
with mlflow.start_run():
    ...
    model_path = "best_predictor.joblib"
    ...
    repo_id = "aravindshaz3/predictor-model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_predictor.joblib",
        path_in_repo="best_predictor.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
